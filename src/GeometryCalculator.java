...
/**
 * Calculadora de geometría mejorada que permite a los usuarios realizar múltiples
 * operaciones de área y perímetro para varias figuras geométricas a través de una
 * interfaz basada en menú. Almacena los resultados de las operaciones en una lista
 * y maneja posibles errores de entrada del usuario.
 */
public class GeometryCalculator {
    ...
    /**
     * Método principal para ejecutar la aplicación de la calculadora de geometría.
     * Presenta menús para la selección de figura y operación, realiza cálculos,
     * maneja errores de entrada y almacena los resultados en una lista.
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                // Captura y maneja elecciones de figura u operación inválidas.
     ...
     * Incluye opciones para Área y Perímetro.
     * @param input El objeto Scanner utilizado para leer la entrada del usuario.
     * @return El entero que representa la elección de operación del usuario (1 para Área, 2 para Perímetro, 0 para volver).
     */
    private static int askOperationMenu(Scanner input) {
        ...
        // Lee y valida la opción del menú del usuario, asegurando que esté dentro del rango válido [0, 2].
        return readMenuOption(input, 2);
    }
    ...
    private static int readMenuOption(Scanner input, int max) {
        ...
        while (true) {
            ...
            try {
                ...
                if (option >= 0 && option <= max) return option; // Retorna la opción válida.
    ...
    /**
     * Calcula el área o el perímetro basándose en las elecciones de figura y operación.
     * @param shapeChoice La figura elegida (1-5).
     * @param operationChoice La operación elegida (1 para Área, 2 para Perímetro).
     * @param input El objeto Scanner para leer las dimensiones necesarias.
     * @return El resultado calculado.
     * @throws IllegalArgumentException si la figura elegida es desconocida.
     */
    private static double calculate(int shapeChoice, int operationChoice, Scanner input) {
        ...
        return switch (shapeChoice) {
            ...
            // Lanza una excepción para elecciones de figura desconocidas.
     ...
     * Solicita al usuario el radio y asegura que sea positivo.
     ...
     * Solicita al usuario la longitud del lado y asegura que sea positivo.
     ...
     * Solicita al usuario la base y la altura y asegura que sean positivos.
     ...
     * Solicita al usuario las longitudes de los tres lados y asegura que sean positivos.
     ...
     * Solicita al usuario la longitud del lado y la apotema y asegura que sean positivos.
